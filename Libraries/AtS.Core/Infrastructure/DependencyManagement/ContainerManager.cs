...
namespace TWYK.Core.Infrastructure.DependencyManagement
{
    /// <summary>
    /// Container manager
    /// </summary>
    public class ContainerManager
    {
        ...
        public virtual T Resolve<T>(string key = "",
            ILifetimeScope scope = null) where T : class {
        ...
        public virtual T ResolveUnregistered<T>(ILifetimeScope scope = null) where T : class {
            return ResolveUnregistered(typeof(T),
                scope) as T;
        }
        ...
        public virtual bool TryResolve(Type serviceType,
            ILifetimeScope scope,
            out object instance) {
            if (scope == null) scope = Scope();
            return scope.TryResolve(serviceType,
                out instance);
        }
