...
namespace TWYK.Core
{
    public class WebHelper : IWebHelper
    {
        ...
        public WebHelper(HttpContextBase httpContext) {
            ...
            _staticFileExtensions = new[] {
                ".axd", ".ashx", ".bmp", ".css", ".gif", ".htm", ".html", ".ico", ".jpeg", ".jpg", ".js", ".png",
                ".rar", ".zip"
            };
        }
        ...
        public virtual bool IsCurrentConnectionSecured() {
            ...
            if (IsRequestAvailable(_httpContext)) {
                ...
                //2. use HTTP_X_FORWARDED_PROTO?
                    ...
                    useSsl = string.Equals(ServerVariables("HTTP_X_FORWARDED_PROTO"),
                        "https",
        ...
        public virtual string ModifyQueryString(string url,
            string queryStringModification,
            string anchor) {
            if (url == null) {
                url = string.Empty;
            }
        ...
        /// <returns>New url</returns>
        public virtual string RemoveQueryString(string url,
            string queryString) {
            if (url == null) {
                url = string.Empty;
            }
