        ...
        private static void InitializeSeoCharacterTable() {
            lock (s_lock) {
                if (_seoCharacterTable == null) {
                    ...
                    _seoCharacterTable.Add(ToUnichar("00D0"),
                        "D"); // LATIN CAPITAL LETTER ETH -- no decomposition  	// Eth [D for Vietnamese]
                    ...
                    _seoCharacterTable.Add(ToUnichar("00DE"),
                        "Th"); // LATIN CAPITAL LETTER THORN -- no decomposition; // Thorn - Could be nothing other than thorn
                    ...
                    _seoCharacterTable.Add(ToUnichar("00F0"),
                        "d"); // LATIN SMALL LETTER ETH -- no decomposition         // small eth, "d" for benefit of Vietnamese
                    ...
                    _seoCharacterTable.Add(ToUnichar("00FE"),
                        "th"); // LATIN SMALL LETTER THORN -- no decomposition  // Small thorn
                    ...
                    _seoCharacterTable.Add(ToUnichar("0110"),
                        "D"); // LATIN CAPITAL LETTER D WITH STROKE -- no decomposition                     // Capital D with stroke
                    _seoCharacterTable.Add(ToUnichar("0111"),
                        "d"); // LATIN SMALL LETTER D WITH STROKE -- no decomposition                       // small D with stroke
                    ...
                    _seoCharacterTable.Add(ToUnichar("0126"),
                        "H"); // LATIN CAPITAL LETTER H WITH STROKE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0127"),
                        "h"); // LATIN SMALL LETTER H WITH STROKE -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("0141"),
                        "L"); // LATIN CAPITAL LETTER L WITH STROKE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0142"),
                        "l"); // LATIN SMALL LETTER L WITH STROKE -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("0149"),
                        "'n"); // LATIN SMALL LETTER N PRECEDED BY APOSTROPHE                              ;
                    _seoCharacterTable.Add(ToUnichar("014A"),
                        "NG"); // LATIN CAPITAL LETTER ENG -- no decomposition                             ;
                    _seoCharacterTable.Add(ToUnichar("014B"),
                        "ng"); // LATIN SMALL LETTER ENG -- no decomposition                               ;
                    ...
                    _seoCharacterTable.Add(ToUnichar("0166"),
                        "T"); // LATIN CAPITAL LETTER T WITH STROKE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0167"),
                        "t"); // LATIN SMALL LETTER T WITH STROKE -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("0180"),
                        "b"); // LATIN SMALL LETTER B WITH STROKE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0181"),
                        "B"); // LATIN CAPITAL LETTER B WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0182"),
                        "B"); // LATIN CAPITAL LETTER B WITH TOPBAR -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0183"),
                        "b"); // LATIN SMALL LETTER B WITH TOPBAR -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("0187"),
                        "C"); // LATIN CAPITAL LETTER C WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0188"),
                        "c"); // LATIN SMALL LETTER C WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0189"),
                        "D"); // LATIN CAPITAL LETTER AFRICAN D -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("018A"),
                        "D"); // LATIN CAPITAL LETTER D WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("018B"),
                        "D"); // LATIN CAPITAL LETTER D WITH TOPBAR -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("018C"),
                        "d"); // LATIN SMALL LETTER D WITH TOPBAR -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("018D"),
                        "d"); // LATIN SMALL LETTER TURNED DELTA -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("018E"),
                        "E"); // LATIN CAPITAL LETTER REVERSED E -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("0191"),
                        "F"); // LATIN CAPITAL LETTER F WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0192"),
                        "f"); // LATIN SMALL LETTER F WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0193"),
                        "G"); // LATIN CAPITAL LETTER G WITH HOOK -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("0197"),
                        "I"); // LATIN CAPITAL LETTER I WITH STROKE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0198"),
                        "K"); // LATIN CAPITAL LETTER K WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0199"),
                        "k"); // LATIN SMALL LETTER K WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("019A"), "l"); // LATIN SMALL LETTER L WITH BAR -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("019B"),
                        "l"); // LATIN SMALL LETTER LAMBDA WITH STROKE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("019C"), "M"); // LATIN CAPITAL LETTER TURNED M -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("019D"),
                        "N"); // LATIN CAPITAL LETTER N WITH LEFT HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("019E"),
                        "n"); // LATIN SMALL LETTER N WITH LONG RIGHT LEG -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("019F"),
                        "O"); // LATIN CAPITAL LETTER O WITH MIDDLE TILDE -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("01A4"),
                        "P"); // LATIN CAPITAL LETTER P WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("01A5"),
                        "p"); // LATIN SMALL LETTER P WITH HOOK -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("01AA"),
                        "s"); // LATIN LETTER REVERSED ESH LOOP -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("01AB"),
                        "t"); // LATIN SMALL LETTER T WITH PALATAL HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("01AC"),
                        "T"); // LATIN CAPITAL LETTER T WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("01AD"),
                        "t"); // LATIN SMALL LETTER T WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("01AE"),
                        "T"); // LATIN CAPITAL LETTER T WITH RETROFLEX HOOK -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("01B2"),
                        "V"); // LATIN CAPITAL LETTER V WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("01B3"),
                        "Y"); // LATIN CAPITAL LETTER Y WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("01B4"),
                        "y"); // LATIN SMALL LETTER Y WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("01B5"),
                        "Z"); // LATIN CAPITAL LETTER Z WITH STROKE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("01B6"),
                        "z"); // LATIN SMALL LETTER Z WITH STROKE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("01B7"), "Z"); // LATIN CAPITAL LETTER EZH -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("01B8"),
                        "Z"); // LATIN CAPITAL LETTER EZH REVERSED -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("01B9"),
                        "Z"); // LATIN SMALL LETTER EZH REVERSED -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("01BA"),
                        "z"); // LATIN SMALL LETTER EZH WITH TAIL -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("01BB"), "2"); // LATIN LETTER TWO WITH STROKE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("01BC"),
                        "5"); // LATIN CAPITAL LETTER TONE FIVE -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("01C5"),
                        "DZ"); // LATIN CAPITAL LETTER D WITH SMALL LETTER Z WITH CARON
                    ...
                    _seoCharacterTable.Add(ToUnichar("01E4"),
                        "G"); // LATIN CAPITAL LETTER G WITH STROKE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("01E5"),
                        "g"); // LATIN SMALL LETTER G WITH STROKE -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("0220"),
                        "N"); // LATIN CAPITAL LETTER N WITH LONG RIGHT LEG -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0221"),
                        "d"); // LATIN SMALL LETTER D WITH CURL -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("0224"),
                        "Z"); // LATIN CAPITAL LETTER Z WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0225"),
                        "z"); // LATIN SMALL LETTER Z WITH HOOK -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("0234"),
                        "l"); // LATIN SMALL LETTER L WITH CURL -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0235"),
                        "n"); // LATIN SMALL LETTER N WITH CURL -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0236"),
                        "t"); // LATIN SMALL LETTER T WITH CURL -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("0252"),
                        "a"); // LATIN SMALL LETTER TURNED ALPHA -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0253"),
                        "b"); // LATIN SMALL LETTER B WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0254"), "o"); // LATIN SMALL LETTER OPEN O -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0255"),
                        "c"); // LATIN SMALL LETTER C WITH CURL -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0256"),
                        "d"); // LATIN SMALL LETTER D WITH TAIL -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0257"),
                        "d"); // LATIN SMALL LETTER D WITH HOOK -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("025A"),
                        "e"); // LATIN SMALL LETTER SCHWA WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("025B"), "e"); // LATIN SMALL LETTER OPEN E -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("025C"),
                        "e"); // LATIN SMALL LETTER REVERSED OPEN E -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("025D"),
                        "e"); // LATIN SMALL LETTER REVERSED OPEN E WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("025E"),
                        "e"); // LATIN SMALL LETTER CLOSED REVERSED OPEN E -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("025F"),
                        "j"); // LATIN SMALL LETTER DOTLESS J WITH STROKE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0260"),
                        "g"); // LATIN SMALL LETTER G WITH HOOK -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("0266"),
                        "h"); // LATIN SMALL LETTER H WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0267"),
                        "h"); // LATIN SMALL LETTER HENG WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0268"),
                        "i"); // LATIN SMALL LETTER I WITH STROKE -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("026B"),
                        "l"); // LATIN SMALL LETTER L WITH MIDDLE TILDE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("026C"),
                        "l"); // LATIN SMALL LETTER L WITH BELT -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("026D"),
                        "l"); // LATIN SMALL LETTER L WITH RETROFLEX HOOK -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("0270"),
                        "m"); // LATIN SMALL LETTER TURNED M WITH LONG LEG -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0271"),
                        "m"); // LATIN SMALL LETTER M WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0272"),
                        "n"); // LATIN SMALL LETTER N WITH LEFT HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0273"),
                        "n"); // LATIN SMALL LETTER N WITH RETROFLEX HOOK -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("0276"),
                        "OE"); // LATIN LETTER SMALL CAPITAL OE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0277"),
                        "o"); // LATIN SMALL LETTER CLOSED OMEGA -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("027A"),
                        "r"); // LATIN SMALL LETTER TURNED R WITH LONG LEG -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("027B"),
                        "r"); // LATIN SMALL LETTER TURNED R WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("027C"),
                        "r"); // LATIN SMALL LETTER R WITH LONG LEG -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("027D"),
                        "r"); // LATIN SMALL LETTER R WITH TAIL -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("027E"),
                        "r"); // LATIN SMALL LETTER R WITH FISHHOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("027F"),
                        "r"); // LATIN SMALL LETTER REVERSED R WITH FISHHOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0280"), "R"); // LATIN LETTER SMALL CAPITAL R -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0281"),
                        "r"); // LATIN LETTER SMALL CAPITAL INVERTED R -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0282"),
                        "s"); // LATIN SMALL LETTER S WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0283"), "s"); // LATIN SMALL LETTER ESH -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0284"),
                        "j"); // LATIN SMALL LETTER DOTLESS J WITH STROKE AND HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0285"),
                        "s"); // LATIN SMALL LETTER SQUAT REVERSED ESH -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0286"),
                        "s"); // LATIN SMALL LETTER ESH WITH CURL -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0287"), "y"); // LATIN SMALL LETTER TURNED T -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0288"),
                        "t"); // LATIN SMALL LETTER T WITH RETROFLEX HOOK -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("028B"),
                        "u"); // LATIN SMALL LETTER V WITH HOOK -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("0290"),
                        "z"); // LATIN SMALL LETTER Z WITH RETROFLEX HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0291"),
                        "z"); // LATIN SMALL LETTER Z WITH CURL -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0292"), "z"); // LATIN SMALL LETTER EZH -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0293"),
                        "z"); // LATIN SMALL LETTER EZH WITH CURL -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0294"), "'"); // LATIN LETTER GLOTTAL STOP -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0295"),
                        "'"); // LATIN LETTER PHARYNGEAL VOICED FRICATIVE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("0296"),
                    ...
                    _seoCharacterTable.Add(ToUnichar("029A"),
                        "e"); // LATIN SMALL LETTER CLOSED OPEN E -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("029B"),
                        "G"); // LATIN LETTER SMALL CAPITAL G WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("029C"), "H"); // LATIN LETTER SMALL CAPITAL H -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("029D"),
                        "j"); // LATIN SMALL LETTER J WITH CROSSED-TAIL -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("02A0"),
                        "q"); // LATIN SMALL LETTER Q WITH HOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("02A1"),
                        "'"); // LATIN LETTER GLOTTAL STOP WITH STROKE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("02A2"),
                        "'"); // LATIN LETTER REVERSED GLOTTAL STOP WITH STROKE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("02A3"),
                        "dz"); // LATIN SMALL LETTER DZ DIGRAPH -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("02A4"),
                        "dz"); // LATIN SMALL LETTER DEZH DIGRAPH -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("02A5"),
                        "dz"); // LATIN SMALL LETTER DZ DIGRAPH WITH CURL -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("02A6"),
                        "ts"); // LATIN SMALL LETTER TS DIGRAPH -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("02A7"),
                        "ts"); // LATIN SMALL LETTER TESH DIGRAPH -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("02A8"),
                        ""); // LATIN SMALL LETTER TC DIGRAPH WITH CURL -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("02A9"),
                        "fn"); // LATIN SMALL LETTER FENG DIGRAPH -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("02AA"),
                        "ls"); // LATIN SMALL LETTER LS DIGRAPH -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("02AB"),
                        "lz"); // LATIN SMALL LETTER LZ DIGRAPH -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("02AC"),
                        "w"); // LATIN LETTER BILABIAL PERCUSSIVE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("02AD"),
                        "t"); // LATIN LETTER BIDENTAL PERCUSSIVE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("02AE"),
                        "h"); // LATIN SMALL LETTER TURNED H WITH FISHHOOK -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("02AF"),
                        "h"); // LATIN SMALL LETTER TURNED H WITH FISHHOOK AND TAIL -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("1D01"),
                        "AE"); // LATIN LETTER SMALL CAPITAL AE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("1D02"), "ae"); // LATIN SMALL LETTER TURNED AE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("1D03"),
                        "B"); // LATIN LETTER SMALL CAPITAL BARRED B -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("1D06"),
                        "TH"); // LATIN LETTER SMALL CAPITAL ETH -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("1D07"), "E"); // LATIN LETTER SMALL CAPITAL E -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("1D08"),
                        "e"); // LATIN SMALL LETTER TURNED OPEN E -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("1D0C"),
                        "L"); // LATIN LETTER SMALL CAPITAL L WITH STROKE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("1D0D"), "M"); // LATIN LETTER SMALL CAPITAL M -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("1D0E"),
                        "N"); // LATIN LETTER SMALL CAPITAL REVERSED N -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("1D0F"), "O"); // LATIN LETTER SMALL CAPITAL O -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("1D10"),
                        "O"); // LATIN LETTER SMALL CAPITAL OPEN O -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("1D11"), "o"); // LATIN SMALL LETTER SIDEWAYS O -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("1D12"),
                        "o"); // LATIN SMALL LETTER SIDEWAYS OPEN O -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("1D13"),
                        "o"); // LATIN SMALL LETTER SIDEWAYS O WITH STROKE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("1D14"), "oe"); // LATIN SMALL LETTER TURNED OE -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("1D15"),
                        "ou"); // LATIN LETTER SMALL CAPITAL OU -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("1D16"), "o"); // LATIN SMALL LETTER TOP HALF O -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("1D17"),
                        "o"); // LATIN SMALL LETTER BOTTOM HALF O -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("1D18"), "P"); // LATIN LETTER SMALL CAPITAL P -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("1D19"),
                        "R"); // LATIN LETTER SMALL CAPITAL REVERSED R -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("1D1A"),
                        "R"); // LATIN LETTER SMALL CAPITAL TURNED R -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("1D1E"),
                        "u"); // LATIN SMALL LETTER SIDEWAYS DIAERESIZED U -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("1D1F"),
                        "m"); // LATIN SMALL LETTER SIDEWAYS TURNED M -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("1D23"),
                        "EZH"); // LATIN LETTER SMALL CAPITAL EZH -- no decomposition
                    _seoCharacterTable.Add(ToUnichar("1D24"),
                    ...
                    _seoCharacterTable.Add(ToUnichar("1D2F"),
                        "B"); // MODIFIER LETTER CAPITAL BARRED B -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("1D3B"),
                        "N"); // MODIFIER LETTER CAPITAL REVERSED N -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("1D4E"),
                        "i"); // MODIFIER LETTER SMALL TURNED I -- no decomposition
                    ...
                    _seoCharacterTable.Add(ToUnichar("1E68"),
                    ...
                    _seoCharacterTable.Add(ToUnichar("1EA8"),
                        "A"); // LATIN CAPITAL LETTER A WITH CIRCUMFLEX AND HOOK ABOVE
                    _seoCharacterTable.Add(ToUnichar("1EA9"),
                    ...
                    _seoCharacterTable.Add(ToUnichar("1EAC"),
                        "A"); // LATIN CAPITAL LETTER A WITH CIRCUMFLEX AND DOT BELOW
                    _seoCharacterTable.Add(ToUnichar("1EAD"),
                    ...
                    _seoCharacterTable.Add(ToUnichar("1EC2"),
                        "E"); // LATIN CAPITAL LETTER E WITH CIRCUMFLEX AND HOOK ABOVE
                    _seoCharacterTable.Add(ToUnichar("1EC3"),
                    ...
                    _seoCharacterTable.Add(ToUnichar("1EC6"),
                        "E"); // LATIN CAPITAL LETTER E WITH CIRCUMFLEX AND DOT BELOW
                    _seoCharacterTable.Add(ToUnichar("1EC7"),
                    ...
                    _seoCharacterTable.Add(ToUnichar("1ED4"),
                        "O"); // LATIN CAPITAL LETTER O WITH CIRCUMFLEX AND HOOK ABOVE
                    _seoCharacterTable.Add(ToUnichar("1ED5"),
                    ...
                    _seoCharacterTable.Add(ToUnichar("1ED8"),
                        "O"); // LATIN CAPITAL LETTER O WITH CIRCUMFLEX AND DOT BELOW
                    _seoCharacterTable.Add(ToUnichar("1ED9"),
                    ...
                    // Greek characters
                    _seoCharacterTable.Add(ToUnichar("0391"), "A"); // GREEK CAPITAL LETTER ALPHA
                    _seoCharacterTable.Add(ToUnichar("0392"), "B"); // GREEK CAPITAL LETTER BETA
                    _seoCharacterTable.Add(ToUnichar("0393"), "G"); // GREEK CAPITAL LETTER GAMMA
                    _seoCharacterTable.Add(ToUnichar("0394"), "D"); // GREEK CAPITAL LETTER DELTA
                    _seoCharacterTable.Add(ToUnichar("0395"), "E"); // GREEK CAPITAL LETTER EPSILON
                    _seoCharacterTable.Add(ToUnichar("0396"), "Z"); // GREEK CAPITAL LETTER ZETA
                    _seoCharacterTable.Add(ToUnichar("0397"), "I"); // GREEK CAPITAL LETTER ETA
                    _seoCharacterTable.Add(ToUnichar("0398"), "TH"); // GREEK CAPITAL LETTER THETA
                    _seoCharacterTable.Add(ToUnichar("0399"), "I"); // GREEK CAPITAL LETTER IOTA
                    _seoCharacterTable.Add(ToUnichar("039A"), "K"); // GREEK CAPITAL LETTER KAPPA
                    _seoCharacterTable.Add(ToUnichar("039B"), "L"); // GREEK CAPITAL LETTER LAM(B)DA
                    _seoCharacterTable.Add(ToUnichar("039C"), "M"); // GREEK CAPITAL LETTER MU
                    _seoCharacterTable.Add(ToUnichar("039D"), "N"); // GREEK CAPITAL LETTER NU
                    _seoCharacterTable.Add(ToUnichar("039E"), "X"); // GREEK CAPITAL LETTER XI
                    _seoCharacterTable.Add(ToUnichar("039F"), "O"); // GREEK CAPITAL LETTER OMICRON
                    _seoCharacterTable.Add(ToUnichar("03A0"), "P"); // GREEK CAPITAL LETTER PI
                    _seoCharacterTable.Add(ToUnichar("03A1"), "R"); // GREEK CAPITAL LETTER RHO
                    _seoCharacterTable.Add(ToUnichar("03A3"), "S"); // GREEK CAPITAL LETTER SIGMA
                    _seoCharacterTable.Add(ToUnichar("03A4"), "T"); // GREEK CAPITAL LETTER TAU
                    _seoCharacterTable.Add(ToUnichar("03A5"), "Y"); // GREEK CAPITAL LETTER UPSILON
                    _seoCharacterTable.Add(ToUnichar("03A6"), "F"); // GREEK CAPITAL LETTER PHI
                    _seoCharacterTable.Add(ToUnichar("03A7"), "X"); // GREEK CAPITAL LETTER CHI
                    _seoCharacterTable.Add(ToUnichar("03A8"), "PS"); // GREEK CAPITAL LETTER PSI
                    _seoCharacterTable.Add(ToUnichar("03A9"), "O"); // GREEK CAPITAL LETTER OMEGA
                    _seoCharacterTable.Add(ToUnichar("03B1"), "a"); // GREEK SMALL LETTER ALPHA
                    _seoCharacterTable.Add(ToUnichar("03B2"), "b"); // GREEK SMALL LETTER BETA
                    _seoCharacterTable.Add(ToUnichar("03B3"), "g"); // GREEK SMALL LETTER GAMMA
                    _seoCharacterTable.Add(ToUnichar("03B4"), "d"); // GREEK SMALL LETTER DELTA
                    _seoCharacterTable.Add(ToUnichar("03B5"), "e"); // GREEK SMALL LETTER EPSILON
                    _seoCharacterTable.Add(ToUnichar("03B6"), "z"); // GREEK SMALL LETTER ZETA
                    _seoCharacterTable.Add(ToUnichar("03B7"), "i"); // GREEK SMALL LETTER ETA
                    _seoCharacterTable.Add(ToUnichar("03B8"), "th"); // GREEK SMALL LETTER THETA
                    _seoCharacterTable.Add(ToUnichar("03B9"), "i"); // GREEK SMALL LETTER IOTA
                    _seoCharacterTable.Add(ToUnichar("03BA"), "k"); // GREEK SMALL LETTER KAPPA
                    _seoCharacterTable.Add(ToUnichar("03BB"), "l"); // GREEK SMALL LETTER LAM(B)DA
                    _seoCharacterTable.Add(ToUnichar("03BC"), "m"); // GREEK SMALL LETTER MU
                    _seoCharacterTable.Add(ToUnichar("03BD"), "n"); // GREEK SMALL LETTER NU
                    _seoCharacterTable.Add(ToUnichar("03BE"), "x"); // GREEK SMALL LETTER XI
                    _seoCharacterTable.Add(ToUnichar("03BF"), "o"); // GREEK SMALL LETTER OMICRON
                    _seoCharacterTable.Add(ToUnichar("03C0"), "p"); // GREEK SMALL LETTER PI
                    _seoCharacterTable.Add(ToUnichar("03C1"), "r"); // GREEK SMALL LETTER RHO
                    _seoCharacterTable.Add(ToUnichar("03C2"), "s"); // GREEK SMALL LETTER FINAL SIGMA
                    _seoCharacterTable.Add(ToUnichar("03C3"), "s"); // GREEK SMALL LETTER SIGMA
                    _seoCharacterTable.Add(ToUnichar("03C4"), "t"); // GREEK SMALL LETTER TAU
                    _seoCharacterTable.Add(ToUnichar("03C5"), "y"); // GREEK SMALL LETTER UPSILON
                    _seoCharacterTable.Add(ToUnichar("03C6"), "f"); // GREEK SMALL LETTER PHI
                    _seoCharacterTable.Add(ToUnichar("03C7"), "x"); // GREEK SMALL LETTER CHI
                    _seoCharacterTable.Add(ToUnichar("03C8"), "ps"); // GREEK SMALL LETTER PSI
                    _seoCharacterTable.Add(ToUnichar("03C9"), "o"); // GREEK SMALL LETTER OMEGA
                    _seoCharacterTable.Add(ToUnichar("0386"), "A"); // GREEK CAPITAL LETTER ALPHA WITH TONOS
                    _seoCharacterTable.Add(ToUnichar("0388"), "E"); // GREEK CAPITAL LETTER EPSILON WITH TONOS
                    _seoCharacterTable.Add(ToUnichar("0389"), "I"); // GREEK CAPITAL LETTER ETA WITH TONOS
                    _seoCharacterTable.Add(ToUnichar("038A"), "I"); // GREEK CAPITAL LETTER IOTA WITH TONOS
                    _seoCharacterTable.Add(ToUnichar("038C"), "O"); // GREEK CAPITAL LETTER OMICRON WITH TONOS
                    _seoCharacterTable.Add(ToUnichar("038E"), "Y"); // GREEK CAPITAL LETTER UPSILON WITH TONOS
                    _seoCharacterTable.Add(ToUnichar("038F"), "O"); // GREEK CAPITAL LETTER OMEGA WITH TONOS
                    _seoCharacterTable.Add(ToUnichar("03AC"), "a"); // GREEK SMALL LETTER ALPHA WITH TONOS
                    _seoCharacterTable.Add(ToUnichar("03AD"), "e"); // GREEK SMALL LETTER EPSILON WITH TONOS
                    _seoCharacterTable.Add(ToUnichar("03AE"), "i"); // GREEK SMALL LETTER ETA WITH TONOS
                    _seoCharacterTable.Add(ToUnichar("03CC"), "o"); // GREEK SMALL LETTER OMICRON WITH TONOS
                    _seoCharacterTable.Add(ToUnichar("03AF"), "i"); // GREEK SMALL LETTER IOTA WITH TONOS
                    _seoCharacterTable.Add(ToUnichar("03CD"), "y"); // GREEK SMALL LETTER UPSILON WITH TONOS
                    _seoCharacterTable.Add(ToUnichar("03CE"), "o"); // GREEK SMALL LETTER OMEGA WITH TONOS
                    _seoCharacterTable.Add(ToUnichar("03AA"), "I"); // GREEK CAPITAL LETTER IOTA WITH DIALYTIKA
                    _seoCharacterTable.Add(ToUnichar("03AB"), "Y"); // GREEK CAPITAL LETTER UPSILON WITH DIALYTIKA
                    _seoCharacterTable.Add(ToUnichar("03CA"), "i"); // GREEK SMALL LETTER IOTA WITH DIALYTIKA
                    _seoCharacterTable.Add(ToUnichar("03CB"), "y"); // GREEK SMALL LETTER UPSILON WITH DIALYTIKA
                    _seoCharacterTable.Add(ToUnichar("03B0"),
                        "y"); // GREEK SMALL LETTER UPSILON WITH DIALYTIKA AND TONOS
                    _seoCharacterTable.Add(ToUnichar("0390"), "i"); // GREEK SMALL LETTER IOTA WITH DIALYTIKA AND TONOS
                }
            }
        }
